...
echo
echo "******************** RECO1 AND RECO2 STAGE"
echo

lar -n $genevents -c $fcls/reco_uboone_mcc8_driver_stage1and2.fcl -s $outdir/prodgenie_bnb_nu_cosmic_dirt_uboone_${run}_gen1_gen2_g4_detsim.root -o $outdir/prodgenie_bnb_nu_cosmic_dirt_uboone_${run}_gen1_gen2_g4_detsim_reco12.root
