...
lar -n $genevents -c $fcls/standard_detsim_uboone.fcl -s ./prodgenie_bnb_nu_cosmic_dirt_uboone_${run}_gen1_gen2_g4.root -o ./prodgenie_bnb_nu_cosmic_dirt_uboone_${run}_gen1_gen2_g4_detsim.root
...
lar -n $genevents -c $fcls/reco_uboone_mcc8_driver_stage1.fcl -s ./prodgenie_bnb_nu_cosmic_dirt_uboone_${run}_gen1_gen2_g4_detsim.root -o ./prodgenie_bnb_nu_cosmic_dirt_uboone_${run}_gen1_gen2_g4_detsim_reco1.root
...
lar -n $genevents -c $fcls/reco_uboone_mcc8_driver_stage2.fcl -s ./prodgenie_bnb_nu_cosmic_dirt_uboone_${run}_gen1_gen2_g4_detsim_reco1.root -o ./prodgenie_bnb_nu_cosmic_dirt_uboone_${run}_gen1_gen2_g4_detsim_reco1_reco2.root
...
lar -n $genevents -c $fcls/run_ubxsec_mc_bnbcosmic.fcl -s ./prodgenie_bnb_nu_cosmic_dirt_uboone_${run}_gen1_gen2_g4_detsim_reco1_reco2.root -o ./prodgenie_bnb_nu_cosmic_dirt_uboone_${run}_gen1_gen2_g4_detsim_reco1_reco2_ubxsec.root
